...
| 07-05 | GS · James Schneider (Semis 2Q Preview) | valuation | bull | GS names **AMAT among its tactical UPSIDE ideas into 2Q** (with AMD, ON), vs downside KLAC/ARM/QCOM. SemiCap sub-sector: **positive estimate revisions** on WFE pull-ins + long-term visibility into 2028. Caveat: SOX +88% vs SPX +14% in 2Q "raises the bar" on the trading setup. Cuts against MS's relative-preference for LAM+KLA over AMAT. (GS / James Schneider, 2026-07-05) |
...
## Changelog
- **2026-07-05** — Added 1 intra-quarter row: **GS/James Schneider "Semiconductors 2Q Preview" (07-05)** names AMAT among tactical *upside* ideas (with AMD, ON); SemiCap positive estimate revisions on WFE pull-ins + 2028 visibility; bar raised after the SOX run. No PT/rating superseded.
