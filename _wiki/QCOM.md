...
|---|--:|--:|
| Revenue | $41.1bn | $45.3bn |
| Gross profit | $22.7bn | $24.9bn |
| Gross margin | 55.2% | 55.0% |
| EBITDA | $13.6bn | $14.9bn |
| EPS | $9.84 | $11.45 |
| Capex | $1.6bn | $1.8bn |
| OCF (≈EBITDA) | $13.6bn | $14.9bn |
...
| 07-05 | GS · James Schneider (Semis 2Q Preview) | valuation | bear | GS names **QCOM ("Q") among its tactical DOWNSIDE ideas into 2Q** (with KLAC, ARM), vs upside AMAT/AMD/ON. Despite broad estimate upside across the semi complex, GS flags a tougher trading setup after SOX +88% vs SPX +14% in 2Q "raised the bar." Consistent with the page's bear camp: 70% of sales still handset, DC re-rate ahead of the proof. (GS / James Schneider, 2026-07-05) |
...
## Changelog
- 2026-07-05 — Added 1 intra-quarter row: **GS/James Schneider "Semiconductors 2Q Preview" (07-05)** names QCOM among tactical *downside* ideas (with KLAC, ARM) vs upside AMAT/AMD/ON; bar raised after the SOX run. No PT/rating superseded.
