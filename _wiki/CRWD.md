...
- **Where the sell-side/buy-side stands:** No dedicated CRWD note on disk, but a **standing Morgan Stanley rating is now confirmed: Overweight since 2024-01-09**, last reference price $434.74 — surfaced only in the MS coverage/disclosure tables of an unrelated MSFT–OpenAI note (MS GVAT/US Enterprise Software, Baer/Castagno, 2025-04-30); that note carries no CRWD thesis, PT or commentary. Otherwise on-disk coverage is read-through and expert-channel only: Barclays/Kalia ran a Westcon Europe cyber-distributor April-Q channel call (PANW/CRWD/ZS/OKTA, briefings 2026-05-07→05-11); JPM/Essex security-software webinar incl. CRWD (2026-05-15); JPM "State of Security" cross-ref (PANW/NET/CRWD). All-In Pod (David Sacks) cited PANW/CRWD in the "FDA for AI" / Mythos framing — frontier labs gaining cyber capability in 3–6 months drives systems-hardening demand (briefing ~mid-May 2026). Octahedron's Databricks deep-dive plots CRWD only as a dot in its data-infra-software EV/Revenue and EV/Rev/Growth (CY25E) comp scatters — no CRWD thesis; included as a high-multiple SaaS reference point.
  ...
  - **MS split-adjusted PT (Meta Marshall, "Risk Reward Update," 2026-07-06):** Morgan Stanley maintains **Overweight, PT $172.00 (split-adjusted, from $172.50)** — a purely **mechanical adjustment** for the **4:1 forward stock split effective at market open July 2, 2026**, not a thesis change. MS scenarios (split-adjusted): **Bull $231 / Base $172 / Bear $93** (Morgan Stanley · Meta Marshall, 2026-07-06). This is the first thesis-bearing MS PT on the page (the standing MS Overweight since 2024-01-09 / ref-price $434.74 carried no PT or commentary — see Changelog for the pre-split $172.50 note).
...
| **Valuation** | FY27 guide raised; FCF margin ≥30%; Rule of 40 = 59 (Q1 FY27) — no explicit multiple given by management | Rothschild & Co Redburn (2026-07-01): Sell — 33x EV/sales NTM (~3x cyber-peer avg), 1% FCF yield, flagged into the 4-for-1 split · Octahedron (fund view, 07-15): CRWD "really well positioned" but "really hard to touch on valuation as they're so consensus" (prefers Rubrik) | **✗ contests** (Redburn Sell + fund's crowding/valuation caveat vs the MS Overweight and bull consolidation case) |
...
| 07-02 | Barclays · Saket Kalia | valuation | neutral | **Mechanical PT cut to $169 for the 4-for-1 split** (executed after close 07-01, trading split-adjusted from this morning). Barclays updates its model to the new share count — 1.036B/1.054B/1.075B/1.097B diluted shares FY27/28/29/30 — no thesis change, PT purely rebased for the split. (Barclays · Saket Kalia, 2026-07-02) |
| 07-06 | Morgan Stanley · Meta Marshall | valuation | neutral | **"Risk Reward Update": Overweight, PT $172.00 (split-adjusted, from $172.50)** — mechanical adjustment for the 4:1 forward stock split effective at market open July 2, 2026; no thesis change. Scenarios (split-adjusted): Bull $231 / Base $172 / Bear $93. First thesis-bearing MS PT on the page (vs the prior thesis-free MS Overweight since 2024-01-09). (Morgan Stanley · Meta Marshall, 2026-07-06) |
| 07-08 | Outperforming the Market (buy-side substack) | demand | bull | **European investor-roadshow readout (CFO + IR), post-1Q27:** management repeatedly described the demand environment as **"unprecedented,"** citing engagement from CEOs/boards/executive teams; framed CRWD as entering a **new growth phase from AI adoption + cybersecurity challenges post-Mythos**, with the most consistent message being an improving demand environment. Independent buy-side note (not broker research), corroborating the bullish tone but lower-tier sourcing. (Outperforming the Market, 2026-07-08) |
| 07-15 | Octahedron 2Q26 LP call (fund view) | demanda | mixed | Octahedron sees cybersecurity demand "ratcheting up" with agent-era security problems and calls CrowdStrike "really well positioned" — but "really hard to touch on valuation as they're so consensus" (the fund prefers Rubrik). (Octahedron 2Q26 call — fund view, 2026-07-15) |
...
- **Research reports (relatórios bons):**
  ...
  - [Octahedron 2Q26 LP call (fund view) (2026-07-15)](../relat%C3%B3rios%20bons/2026_07_15_octahedron_2q_review.html) — cyber demand "ratcheting up" with agent-era security problems; CRWD "really well positioned" but "really hard to touch on valuation as they're so consensus" (fund prefers Rubrik) — fund estimates, not a sell-side rating.
