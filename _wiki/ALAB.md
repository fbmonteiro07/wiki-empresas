...
- **MS reiterates Overweight — leading pure-play, but valuation high; attention shifts Scorpio → ecosystem breadth (MS "Bringing More Light to Scale-Up Networks — Updated Scale-Up Primer", Meta Marshall / Joseph Moore, 2026-07-13):** MS 4x's its scale-up TAM to **~$70bn by 2030** and keeps **ALAB Overweight as a leading pure-play beneficiary** (excited for the ramp of **Scorpio, UALink and optics**), though **valuation is high at this point**. MS expects **Scorpio to drive a strong 2H26 ramp**, but investor attention is **already moving toward UALink adoption + customer diversification beyond the initial hyperscaler programs**; it remains "impressed by ALAB's ability to expand content per accelerator from roughly **$50-100 at IPO to more than $1,000**," with **Scorpio X now shipping** the next leg of content growth. On copper-to-optics: **not imminent** — copper retains meaningful intra-rack runway while ALAB builds its optical roadmap (small acquisitions + organic); optics is **longer-term optionality, not an immediate risk to the core thesis**. (MS "Updated Scale-Up Primer", 2026-07-13)
...
- **Bull:**
  ...
  - **Memory-interface-chip demand tailwind (Bernstein · Qingyuan Lin / David Dai, "Memory Interface Chip Primer," 2026-07-08):** the agentic-AI boom is driving demand across the memory-interface-chip complex (RCD/MRCD/MDB/CKD, CXL); Bernstein reiterates **Outperform on Montage (PT raised HKD 320→520 / CNY 220→400)** and on **Renesas** — a positive read-through for the memory-interface/CXL complex, incl. Astera Labs' Leo CXL controllers + PCIe/CXL switching content. (bull; demanda)
- **Bear:**
...
| 07-08 | Bernstein · Qingyuan Lin / David Dai ("Memory Interface Chip Primer") | demand | bull | Agentic-AI boom driving memory-interface-chip demand (RCD/MRCD/MDB/CKD, CXL); reiterates **Outperform on Montage (PT HKD 320→520 / CNY 220→400)** and Renesas — a positive read-through for the memory-interface/CXL complex, incl. ALAB's Leo CXL controllers + PCIe/CXL switching content. (Bernstein "Memory Interface Chip Primer", 2026-07-08) |
| 07-13 | Morgan Stanley · Marshall/Moore | product | bull | **"Bringing More Light to Scale-Up Networks: An Updated Scale-Up Primer"** (scale-up TAM 4x'd to ~$70bn by 2030). Reiterate **Overweight** — ALAB a **leading pure-play beneficiary** (excited for Scorpio/UALink/optics ramp), though **valuation high**. Scorpio drives a **strong 2H26 ramp**, but attention **shifts from Scorpio to ecosystem breadth** (UALink adoption + customer diversification); content/accelerator expanded **~$50-100 at IPO → >$1,000**, Scorpio X now shipping the next leg. Copper-to-optics **not imminent** (copper keeps intra-rack runway); optics = **longer-term optionality, not a near-term risk** to the core thesis. (MS / Meta Marshall / Joseph Moore, 2026-07-13) |

**Quarter synthesis:** the flow confirms management's scale-up thesis (Scorpio X ramping, Amazon the anchor) — the debate migrated from demand to the **share price**: BofA endorses the fundamentals but locks at NEUTRAL on the multiple (66x), and the only remaining operational nuance is the still-subordinate position in AEC vs Credo. **07-13: MS's Updated Scale-Up Primer** (scale-up TAM 4x'd to ~$70bn by 2030) reiterates **Overweight** — ALAB a leading pure-play with content/accelerator up from ~$50-100 at IPO to >$1,000 and Scorpio X now shipping — but echoes the same tension: **valuation high**, and attention shifting from Scorpio to the UALink/customer-diversification breadth, with copper-to-optics not imminent (optics longer-term optionality). Two constructive-but-valuation-gated reads (MS OW-but-rich, BofA NEUTRAL) frame the debate as price, not product.
...
- **Research reports (relatórios bons):**
  ...
  - [Morgan Stanley (Marshall/Moore) — "Bringing More Light to Scale-Up Networks: An Updated Scale-Up Primer" (2026-07-13)](../relat%C3%B3rios%20bons/TELECOM_20260713_0418.html) — scale-up TAM 4x'd to ~$70bn by 2030; ALAB reiterate Overweight, leading pure-play (Scorpio/UALink/optics ramp) but valuation high; content/accelerator ~$50-100 IPO → >$1,000; attention shifting Scorpio → ecosystem breadth; copper-to-optics not imminent (optics longer-term optionality).
