...
_intra-quarter (recent IPO) · May 06 → Jun 22, 2026 · sell-side / expert calls / reports between earnings. Timeline visual: [timeline.html](timeline.html)._
...
| **Capacity / supply** | Multi-year ramp underpinned by OpenAI; AWS (WSE-3) signed Mar-2026 | Arcuri: "not a demand question, it's a supply question" — TSMC wafer order closed in Feb counting only on OpenAI; meaningful AWS unlikely before 2027 | **✗ contests** (supply gates AWS) |
