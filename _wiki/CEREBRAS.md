...
| **Jalapeño / anchor customer** | OpenAI take-or-pay ~$25B; Codex-Spark niche = fast LLM inference | OpenAI announces the "Jalapeño" chip (Broadcom partnership) for its own inference — a direct threat to Cerebras's niche; CBRS -19% below the IPO price | **✗ contests** (anchor customer develops a substitute) |
