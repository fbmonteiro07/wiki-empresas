...
| **Competition / GaN share** | Has GaN + SiC across the grid-to-GPU path ("having both makes a difference") | Citi: GaN winners are TXN/ON, not NVTS · @insane_analyst: "SiC is garbage, only GaN has value" · BofA (Watts to Tokens): GaN pool fastest-growing (69% CAGR) & NVTS named on 800V-to-50V/6V IBC — but NVTS in "Other," no named share | **✗ contests** (pool grows, but named share open across the board) |
...
- **Research reports (relatórios bons):**
  ...
  - [BofA "Watts to Tokens" full industry model (Arya/Jang/Mani/Scemama, 2026-05-25)](../relat%C3%B3rios%20bons/Bofa_Watt_to_tokens.html) — GaN pool $118m→$1,612m (69% CAGR, fastest device type); NVTS named on 800V-to-50V/6V IBC conversion (GaN the leading IBC material for high-power racks); NVTS in "Other," no named revenue/share line.
  ...
  - [MS "The Analog Playbook: 2Q26" (Joe Moore / Lee Simpson, 2026-07-13)](../relat%C3%B3rios%20bons/TECHNOLOGY_20260713_0400.html) — NVTS Underweight, PT $13.7; GaN increasingly competitive (STM/IFX/Renesas inroads), NVDA 800V too early to price in, losses until 2026e; CY26 rev $43mn / GM ~39%.
