...
| **SKHYNIX / SAMSUNG** | MS Korea: SK hynix **+KRW1,000tn** AI-DC capex (nearly doubled commitment); Samsung extended chip/HBM plan; Korea "Three Mega Projects" ~KRW2,000tn/$1.5tn (MS "S. Korea Industrial Strategy", 07-01) | On-page already carry JPM ~$3.1tn and DIGITIMES KRW2,655tn for the **same June-29 announcement** — different scopes, NOT merged | No house model | PENDING | **Scope divergence across brokers on one announcement** — flagged on-page, not reconciled to a single number. The signal is the capex-commitment direction, not the headline size. |
...
| **SAMSUNG** | MS OW, **DRAM Top Pick**; 20-30% DRAM price hikes 3Q26; 5.2x 2027e P/E; prefers DRAM > NAND (MS, 07-02) | Consistent with existing bullish-DRAM comments on page | No house model; BBG PENDING. Confirms. |
...
## Action items
1. **Reconnect Bloomberg Terminal / Capstone VPN** and re-run `py "E:\Wiki Felipe empresas\_wiki\_tools\refresh_features.py" --run-estimates` to fill the BBG PENDING column (place each MS/UBS PT vs consensus median, esp. MEDIATEK NT$6,500 and the memory PTs).
