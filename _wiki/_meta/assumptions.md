...
_Generated 2026-07-02 from `_data/assumptions.json` (asof 2026-07-01). Every cross-page industry number lives here once, with all sourced variants. When a new source disagrees, add a variant to the JSON — never silently rebase a page. Rebuild: `py _wiki/_tools/build_assumptions.py`._
...
- `themes/ai-datacenter-power.md` — …rc_recap_30_apr_2026.html) — ~$35B capex/GW, ~$12B cloud rev/GW; Google +2.5–3 GW/yr; Amazon ~20%+ per-…
- `themes/hyperscaler-capex.md` — …capacity partnerships valued at **~$50B/GW**. This is the structural pivot — see new Key debates axis…
- `themes/tokenmaxxing.md` — …compute deals, monetizing at **~$22–23B/GW/yr (Anthropic) and ~$50B/GW/yr (Google) vs ~$14B/GW/yr impl…
