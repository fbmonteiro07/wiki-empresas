...
_Generated 2026-07-04 from `_data/assumptions.json` (asof 2026-07-01). Every cross-page industry number lives here once, with all sourced variants. When a new source disagrees, add a variant to the JSON — never silently rebase a page. Rebuild: `py _wiki/_tools/build_assumptions.py`._
...
- `AMZN.md` — …th), with Anthropic Bedrock revenue ~$26M/MW in 1Q26 → ~$42M/MW in 2Q implying Bedrock EBIT margins ~55%…
...
- `themes/hyperscaler-capex.md` — …SpaceX-style on-demand compute at ~$50B/GW-of-annual-revenue where 200MW ≈ >$10B/yr) are why Meta can…
