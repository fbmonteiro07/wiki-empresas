...
_Generated 2026-07-07 from `_data/assumptions.json` (asof 2026-07-01). Every cross-page industry number lives here once, with all sourced variants. When a new source disagrees, add a variant to the JSON — never silently rebase a page. Rebuild: `py _wiki/_tools/build_assumptions.py`._
...
- `AMZN.md` — …~15GW 2026-27) at the lowest cost (~$25B/GW)** — a potential growth advantage vs GOOG/META. Biggest 2Q…
